        ...
        <div>
          ...
          <div class="intro-container">
            <p class="intro-paragraph">
              Welcome to Gauntlet Designs. We are a family owned business
              located in the DC Metro Area. We build beautiful, custom-made
          ...
          >
            <Grid item xs={12} md={4}>
              ...
              >
                ...
                <h2 class="bullet-title">DESIGN</h2>
                <p class="bullet-paragraphs">
                  Each website is uniquely created by our designers. We do not
                  use pre-built themes or templates which results in faster,
                  responsive websites.
                </p>
              </Item>
            </Grid>
            <Grid item xs={12} md={4}>
              ...
              >
                ...
                <h2 class="bullet-title">DEVELOPMENT</h2>
                <p class="bullet-paragraphs">
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                ...
                <h2 class="bullet-title">HOSTING</h2>
                <p class="bullet-paragraphs">
                  Let us build your website from the ground up. We make it
                  simple. If you already have a hosting company and domain name,
                  no problem!
                </p>
              </Item>
            </Grid>
